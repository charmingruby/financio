/*
  ...
  - The values [OUTCOME] on the enum `transaction_type` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "transaction_type_new" AS ENUM ('INCOME', 'EXPENSE');
ALTER TABLE "transaction_categories" ALTER COLUMN "type" TYPE "transaction_type_new" USING ("type"::text::"transaction_type_new");
